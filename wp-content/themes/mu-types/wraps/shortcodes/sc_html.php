...
add_shortcode('dotted', 'theme_sc_dotted');
...
/***************************************************************************
 * Add shortcode [dotted]
***************************************************************************/
function theme_sc_dotted($atts, $content = null)
{
	extract(shortcode_atts(
        array(
            'top' => '0',
    ...
    $output = '<div class="sc-dotted" style="margin-top: '.$top.'px; margin-bottom: '.$bottom.'px;"></div>'."\n";
...
function theme_sc_hr($atts, $content = null) 
{
    ...
    $output = '<div class="sc-hr" style="margin-top: '.$top.'px; margin-bottom: '.$bottom.'px;"></div>'."\n";
