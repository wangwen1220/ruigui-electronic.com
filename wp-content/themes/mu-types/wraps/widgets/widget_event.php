...
class Widget_Events extends WP_Widget{
	...
	{
		$title_ops = esc_html__(THEME_NAME.'&raquo; Events','HK');
		$widget_ops = array('classname'=>'widget-events widget-posts','description'=>esc_html__('This widget will display a events section. ','HK'));
		$control_ops = array('width'=>250);
		$this->WP_Widget(THEME_SLUG. '_events',$title_ops,$widget_ops,$control_ops);
	}
	...
	function widget($args,$instance)
	{
		...
		<section>
			...
			<p class="post-meta">
			<?php esc_html_e('Costs: ','HK'); ?><?php echo $costs; ?>
			</p>
		</section>
		</li>
