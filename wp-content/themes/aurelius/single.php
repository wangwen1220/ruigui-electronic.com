<?php get_header(); ?>
	...
	<div class="grid_8">
		...
		<div class="post">
			...
			<!-- Post Title -->
			<img class="thumb" src="<?php bloginfo('template_url'); ?>/img/610x150.gif" alt=""/>
			<!-- Post Content -->
		...
		<ol class="commentlist">
			<li class="comment">
				<div class="gravatar"> <img alt="" src='<?php bloginfo('template_url'); ?>/img/gravatar.png' height='48' width='48' /> <a class="comment-reply-link" href=''>Reply</a> </div>
