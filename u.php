...
<title>PHP探针-UPUPW环境集成包APACHE经典终极版</title>
<meta name="keywords" content="PHP探针,PHP组件,UPUPW,UPUPW集成包,apache,php,eAccelerator,ionCube,memcache,Zend Optimizer,SendMail" />
<meta name="description" content="UPUPW环境集成包APACHE经典终极版PHP探针可检测ionCube,eAccelerator,memcache,Zend Optimizer,SendMail等PHP组件." />
...
<table class="info tablex2">
  ...
  <tr>
    <td class="er">MSSQL Client组件</td>
    <td class="fl"><?=function_exists('mssql_close') ? YES : NO ?></td>
  </tr>
  <tr>
...
<tr>
<td class="el" width="25%">Zend Optimizer</td>
<td class="el">ionCube Loader</td>
<td class="el" width="25%">eAccelerator</td>
...
<td class="fc"><?=function_exists('eaccelerator_info') ? YES.' / '.get_ea_info('version') : NO ?></td>
