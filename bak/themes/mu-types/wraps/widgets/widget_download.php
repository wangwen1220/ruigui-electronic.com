...
/* Download widget */
/*---------------------------------------------------------------------------------*/
class Widget_Downloads extends WP_Widget{
	...
	{
		$title_ops = esc_html__(THEME_NAME.'&raquo; Downloads','HK');
		$widget_ops = array('classname'=>'widget-downloads widget-posts','description'=>esc_html__('This widget will display a downloads section. ','HK'));
		$control_ops = array('width'=>250);
		$this->WP_Widget(THEME_SLUG. '_downloads',$title_ops,$widget_ops,$control_ops);
	}
	...
	function widget($args,$instance)
	{
		...
		<section>
			...
			<p class="post-meta">
			<?php esc_html_e('Version: ','HK'); ?><?php echo $version; ?>
			</p>
		</section>
		</li>
...
register_widget( 'Widget_Downloads' );
