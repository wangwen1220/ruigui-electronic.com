...
class Social_Media_Widget extends WP_Widget{
	...
	function Social_Media_Widget(){
		$title_ops = esc_html__(THEME_NAME.'&raquo; Social Media','HK');
		$widget_ops = array('classname'=>'widget-social-media','description'=>esc_html__('This is a social media list.','HK'));
